...
FastAPI with a PostgreSQL catalog, separate offers, Alembic migrations and an explicit resumable Pok̩API importer. See the [root README](../README.md) for all routes, import scope, architecture and memory limits.
