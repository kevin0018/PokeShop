...
`pnpm build` runs type checking and bundling sequentially. Source folders separate Pokémon, cart, shared preferences and UI translations. Catalog URL state is independent of the Pinia entity cache; cart storage contains only IDs and quantities.
